---
title: "MTA/Rideshare Revenue Analysis"
author: "by Hassan Adolphus"
editor: visual
code-fold: true
---
...
```{r library-imports_[1], warning=FALSE}
...
```{r rideshare-data_[5], warning=FALSE}
...
```{r rideshare-tables_[6], warning=FALSE}
...
```{r rideshare-rows_[7], warning=FALSE}
...
```{r rideshare-trips-plot_[8], warning=FALSE}
...
```{r box-revenue-rideshares_[9], warning=FALSE}
...
```{r data-merging_[10], warning=FALSE}
...
```{r visualize-the-vars_[11], warning=FALSE}
