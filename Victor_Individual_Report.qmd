---
title: Victor Individual Report
format: html
editor: visual
css: styles.css
---
...
Crimes <- read_csv("data/crimes_output.csv")
Precinct_Location <- read_csv("data/Precinct_Location.csv")
Complaint <- read_csv("data/complaint.csv")
```
...
borough_summary <- borough_arrests |>
  mutate(
