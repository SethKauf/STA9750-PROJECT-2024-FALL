...
```{r read-cars-data_[2], echo=TRUE, message=FALSE, warning=FALSE}
#| code-fold: TRUE
...
```{r group-cars-data_[3], echo=TRUE, message=FALSE, warning=FALSE}
#| code-fold: TRUE
...
```{r veh-reg-by-county_[4], echo=TRUE, message=FALSE, warning=FALSE}
#| code-fold: TRUE
...
```{r veh-reg-by-county-2_[6], echo=TRUE, message=FALSE, warning=FALSE}
#| code-fold: TRUE
...
```{r pivoting-and-filtering_[7], echo=TRUE, message=FALSE, warning=FALSE}
#| cold-fold: TRUE
